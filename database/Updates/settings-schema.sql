...
IF NOT EXISTS (SELECT 1 FROM CONFIG_PARAMETROS WHERE CLAVE = 'busqueda_producto_multientidad')
  INSERT INTO CONFIG_PARAMETROS (MODULO, SUBMODULO, CLAVE, DESCRIPCION, TIPO, VALOR_DEFECTO, ORDEN)
  VALUES ('general', 'busqueda_productos', 'busqueda_producto_multientidad', 'Buscar productos por nombre, código, marca y categoría en el buscador avanzado', 'boolean', 'false', 40);
