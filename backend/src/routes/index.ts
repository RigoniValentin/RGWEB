...
import mobileRegisterRoutes from './mobileRegister.routes.js';
...
import tunnelRoutes from './tunnel.routes.js';
...
router.use('/mobile', mobileRegisterRoutes);
...
router.use('/integraciones/tunnel', tunnelRoutes);
