...
export function NuevaOrdenPagoModal({
  ...
  const [metodoModalSelection, setMetodoModalSelection] = useState<number[]>([]);  const [chequesIds, setChequesIds] = useState<number[]>([]);
        ...
        title={
          <RGCajaModalHeader
            ...
            subtitle={isEdit
              ...
              : 'Registrá un pago a proveedor desde la cuenta corriente'}
          />
        }
        open={open}
        onOk={handleOk}
